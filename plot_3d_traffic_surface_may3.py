...
# 读取数据
file_path = r'f:\Math_model\CUMCM2024Problems\E\问题4支撑材料\5月3日车流量统计.csv'
...
# 设置标题
ax.set_title('5月3日车流量三维曲面图')

# 保存图像
plt.savefig(r'f:\Math_model\CUMCM2024Problems\E\问题4支撑材料\5月3日车流量三维曲面图.png', dpi=300, bbox_inches='tight')
plt.show()